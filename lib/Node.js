...
class Node {
     ...
     */
    run(runningNodes, metadata = void 0) {
        if (_.isNil(this._type)) {
            ...
            const myProcess = new fork(path.join(__dirname, `process.js`), void 0, {
            ...
            this._promise = this._run(metadata);
    ...
    async _run(metadata) {
        ...
        utils.mergeNotes(returnValue.messages);
