...
class Migrate {
    ...
    constructor(repository) {
        ...
        /** @type {{tenant: string, esHost: string, indicesInfo: {INDICES: Record<string, {name: string, types: {initial: boolean, versions: Array<{from: string, types: boolean}>}, maxBulkSize: number}>}, migrationPath: string}} */
     ...
     * @param tenant {string}
     * @param esHost {string}
     * @param indicesInfo {{INDICES: Record<string, {name: string, types: {initial: boolean, versions: Array<{from: string, types: boolean}>}, maxBulkSize: number}>}}
     * @param migrationPath {string}
     * @returns {Promise<Migration>}
     */
    async initialize(tenant, esHost, indicesInfo, migrationPath)  {
        this._metadata = {
            tenant, esHost, indicesInfo, migrationPath
        };
