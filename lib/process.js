        ...
        try {
            if (value?.type === `__run`) {
                ...
                if (data.metadata.migrationsConfig) {
                    logger.setLoggerConfig(data.metadata.migrationsConfig);
                }
                ...
                await elastic.createElastic(data.metadata.tenant, data.metadata.esHost, data.metadata.indicesInfo, data.metadata.elasticsearchConfig);
