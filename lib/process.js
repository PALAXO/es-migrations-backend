...
class MigrationProcess {
    ...
    /**
     * Main function
     * @param metadata {{tenant: string, esHost: string, indicesInfo: {INDICES: Record<string, {name: string, allowed: {initial: boolean, versions: Array<{from: string, allowed: boolean}>}, types: {initial: boolean, versions: Array<{from: string, types: boolean}>}, maxBulkSize: number}>}, migrationPath: string}}
     * @param backgroundToProcessData {Array<Array<*>>}
